...
//With a blend tree to control the inputmagnitude and allow blending between animations.
	...
	public class MovementInput2 : MonoBehaviour, IInjectable
	{
		...
		void Update()
		{
			...
			// _playerControl.PositionUpdated(controller.transform.position);
		}
		...
		{
			transform.rotation =
				Quaternion.Slerp(transform.rotation, Quaternion.LookRotation(pos), desiredRotationSpeed);
		}
